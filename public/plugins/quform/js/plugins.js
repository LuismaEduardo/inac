	...
	var Quform = function($form, options) {
		...
		self.reset = function (resetValues) {
			...
			if (options.reset && resetValues) {
				...
				// Reset file imagenes fields properly in IE10+
